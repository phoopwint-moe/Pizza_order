...
@section('breadcrumb_one')
    <a class="breadcrumb-item text-dark" href="{{ route('useracc#edit') }}">Update</a>
@endsection
@section('content')
            ...
            <div class="col-lg-10 offset-1">
                <div class="card">
                    <div class="card-body p-3"> 
                        ...
                        <hr>
                        <form action="{{ route('useracc#update', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row my-3">
