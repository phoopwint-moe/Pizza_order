            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('cat#list')}}" class="text-decoration-none">
                        ...
                        <li>
                            <a href="{{route('useracc#list')}}" class="text-decoration-none">
                            <i class="fa-solid fa-users"></i>User List</a>
                        </li>
                        <li>
                            <a href="{{route('admin#contact')}}" class="text-decoration-none">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <div class="">
                            <h3>Martzo Admin Dashboard Panel</h3> <span>-> @yield('menu')</span>
                            </div>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            @if (Auth::user()->img == null)
                                                <img src="{{asset('img/default.webp')}}" alt="John Doe" class="rounded-circle img-thumbnail" />
                                            @else
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{route('acc#info')}}" class="text-decoration-none">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{route('logout')}}" method="post" class="d-flex justify-content-center my-3 py-2">
                                                   @csrf 
                                                    <button type="submit" class="btn bg-dark text-white col-10 "><i class="zmdi zmdi-power mx-3"></i>Logout</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
